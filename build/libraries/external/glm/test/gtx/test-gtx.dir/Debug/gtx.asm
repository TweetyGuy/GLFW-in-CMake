...
CONST	SEGMENT
$SG74444 DB	'invalid argument', 00H
	ORG $+3
$SG74445 DB	'%s', 00H
	ORG $+1
$SG74449 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG74446 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
$SG70071 DB	'true', 00H
	ORG $+3
$SG74447 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
...
; File C:\Users\ksart\OneDrive\Desktop\FlappyBird\libraries\external\glm\test\gtx\gtx.cpp
_TEXT	SEGMENT
Error$ = 0
main	PROC
